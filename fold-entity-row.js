...
class FoldEntityRow extends s {
    ...
    async flowHeight(height) {
        if (this._config.no_animation)
            return this.snapHeight(height);
        this.itemsContainer.style.maxHeight = `${height}px`;
        this.requestUpdate();
    ...
    async toggle(ev) {
        ...
        if (this.open) {
            ...
            setTimeout(() => this.itemsContainer.classList.remove("clip"), TRANSITION_DELAY + 50);
        }
        // Accessibility
        if (this._config.clickable) {
            this.head.ariaLabel = this.open
...
__decorate([
    i$1("#items")
], FoldEntityRow.prototype, "itemsContainer", void 0);
__decorate([
    i$1("#measure")
], FoldEntityRow.prototype, "measureContainer", void 0);
